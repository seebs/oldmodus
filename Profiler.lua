...
local files = {}
local returned
local function enable_sampling()
  debug.sethook(returned, "cr", 503)
end
...
returned = function(phase,_,err)
	...
	if((phase == "line" or phase == "count") and (isLuaFunction or currentParams.mode==1)) then		
...
if currentParams.callback then
  currentParams.callback()
end
